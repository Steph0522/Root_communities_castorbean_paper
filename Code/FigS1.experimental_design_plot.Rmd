...
ricinus<-load.image(file = "../Figures/ricinus2.jpg")
...
p1<- plot_grid(photo_panel, photo_panel2, labels = c("A", "B"))
p2<- plot_grid(p1, table_experiment, labels = c("", "C"), nrow =  2)
p2

#ggsave('Figures_final/FigS1.design.pdf', width = 10, height = 5, dpi = 300, plot = p2)
